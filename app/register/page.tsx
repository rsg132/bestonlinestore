    ...
    <main className="min-h-screen bg-slate-50 py-16">
      <div className="max-w-3xl mx-auto px-6">
        <div className="mb-10 text-center">
          <p className="text-sm uppercase tracking-[0.3em] text-green-700">Create account</p>
          <h1 className="mt-4 text-4xl font-bold text-slate-900">Register as a user</h1>
          <p className="mt-3 text-slate-600">
            Sign up for a customer, admin, vendor, or rider account and get access to the right panel.
          </p>
        </div>
        ...
        <div className="rounded-[32px] border border-slate-200 bg-white p-10 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700">Choose your role</label>
              <select
                value={role}
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            Already have an account? <Link href="/login" className="font-semibold text-green-700 hover:text-green-800">Login</Link>
          </p>
        </div>
      </div>
    </main>
